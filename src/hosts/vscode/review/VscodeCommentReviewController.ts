...
export class VscodeCommentReviewController extends CommentReviewController implements vscode.Disposable {
	...
	constructor() {
		...
		this.commentController = vscode.comments.createCommentController("cline-cn-ai-review", "Cline AI Review")
		...
		this.disposables.push(
			vscode.commands.registerCommand("cline-cn.reviewComment.reply", async (reply: vscode.CommentReply) => {
		...
		this.disposables.push(
			vscode.commands.registerCommand("cline-cn.reviewComment.addToChat", async (thread: vscode.CommentThread) => {
